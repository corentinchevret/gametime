 ...
 */
class gametimebox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "gametime@gametime";
    public $boxlabel;
    public $depends = array("gametime");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/gametime/class/gametime.class.php";
